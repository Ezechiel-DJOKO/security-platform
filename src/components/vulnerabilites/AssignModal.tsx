...
import { User, X } from 'lucide-react'; // Utilisation exclusive de lucide-react pour les icônes
...
export default function AssignModal({ open, onClose, vulnerability, onSuccess }: AssignModalProps) {
  ...
  useEffect(() => {
    if (open) {
      fetchUsers();
      setAssigneA(''); // Reset à chaque ouverture
    }
  }, [open]);
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      ...
      <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-lg border border-slate-200 dark:bg-slate-900 dark:border-slate-800">
        ...
        {/* En-tête / DialogHeader */}
        <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-3隔">
        ...
        <div className="space-y-5 py-4">
          ...
          {/* Sélection de l'utilisateur / Remplacement Select Shadcn */}
          ...
          {/* Priorité / Remplacement Select Shadcn */}
          <div className="flex flex-col gap-1.5">
        ...
        {/* Pied de page / Remplacement Button Shadcn */}
