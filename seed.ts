...
async function main() {
  ...
  console.log("✅ 3 Utilisateurs créés avec le mot de passe : password123");
  ...
  const actifs = await Promise.all([
    ...
    prisma.actif.create({ 
      data: { 
        nom: "Application Web E-commerce", 
  ...
  console.log("→ superviseur@test.com / password123");
  console.log("→ auditeur@test.com / password123");
}
